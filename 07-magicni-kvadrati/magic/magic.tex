...
\definecolor{bordo}{HTML}{800020}
\newcommand{\pojem}[1]{\emph{\color{bordo}#1}}
...
\begin{table}[H]
   ...
   \begin{tabular}{lcccccc}\toprule
      ...
      red & 1 & 2 & 3 & 4 & 5 & 6 \\
      število kvadratov & 1 & 0 & 1 & 880 & 275305224 & $(1.7745 \pm 0.0010 \times 10^{19})$ \\\bottomrule
   \end{tabular}
\end{table}
% Konec tabele
...
\begin{table}[H]
   ...
   \label{table:mag9}
   \large\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
      \hline
